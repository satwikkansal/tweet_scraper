...
def url_builder(search_type='tweets', search_query='', language='hi', location='New Delhi, India',
                location_range='25mi', start_time='', end_time='', include_retweets=True, positive=False, questions='',
                negative=False):
    params = {
        'f': search_type,
        'q': '',
...
def extract_tweets(html):
    ...
    for tweet in tweets_soup:
        ...
        try:
            ...
            tweet_tuple = (author_link, author_avatar, tweet_text)
        except:
            pass
